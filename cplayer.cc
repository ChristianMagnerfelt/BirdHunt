...
namespace ducks
{
	...
	CAction CPlayer::Shoot(const CState &pState,const CDeadline &pDue)
	{
		...
		statesM.print();
		std::cout << std::endl;
		Matrix obsM = {	{0.07,0.07,0.07,0.07,0.07,0.07,0.07,0.07,0.07,0.07,0.07,0.07,0.08,0.08},
						{0.07,0.07,0.07,0.07,0.07,0.07,0.07,0.07,0.07,0.07,0.07,0.07,0.08,0.08},
						{0.07,0.07,0.07,0.07,0.07,0.07,0.07,0.07,0.07,0.07,0.07,0.07,0.08,0.08},
						{0.07,0.07,0.07,0.07,0.07,0.07,0.07,0.07,0.07,0.07,0.07,0.07,0.08,0.08}};
		obsM.print();
		std::cout << std::endl;
